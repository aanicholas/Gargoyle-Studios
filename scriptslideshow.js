(function initSlideshows(){
  const sliders = Array.from(document.querySelectorAll(".slideshow"));
  ...
  sliders.forEach((slider, idx) => {
    ...
    if (!viewport || !dotsWrap || slides.length === 0 || btns.length < 2) {
      console.warn(`[slideshow ${idx}] Missing required elements`, {
        viewport: !!viewport,
        dotsWrap: !!dotsWrap,
    ...
    console.log(`[slideshow ${idx}] initialized (${slides.length} slides)`);
  });
})();
